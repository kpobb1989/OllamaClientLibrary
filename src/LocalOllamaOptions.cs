...
namespace OllamaClientLibrary
{
    ...
    {
        public override string Model { get; set; } = Environment.GetEnvironmentVariable("OLLAMA_MODEL") ?? "deepseek-r1";
        ...
        public override string? ApiKey { get; set; } = Environment.GetEnvironmentVariable("OLLAMA_API_KEY") ?? null;
    }
}