...
namespace OllamaClientLibrary.Abstractions
{
    ...
    public interface IOllamaClient : IDisposable
    {
        ...
        /// <summary>
        /// Processes a file (document or image) and generates a text response based on its content.
        /// </summary>
        /// <param name="prompt">The prompt to send to the model along with the file content.</param>
        /// <param name="file">The file to process, containing stream data and metadata.</param>
        /// <param name="ct">The cancellation token (optional).</param>
        /// <returns>The text response generated by the model based on the file content.</returns>
        /// <remarks>
        /// This method supports different file processing strategies:
        /// - OCR extraction for text from any file when UseOcrToExtractText is enabled
        /// - PDF document processing (converts to images)
        /// - Direct image processing
        /// 
        /// The file content is incorporated into the conversation history along with the prompt,
        /// and any tool calls in the response are handled automatically.
        /// </remarks>
